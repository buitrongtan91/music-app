...
export default function Register(props: IRegisterProps) {
    ...
    const submitHandler = React.useCallback(() => {
        ...
        dispatch(
            registerAction({ email, username, password, first_name, last_name, birth_date: birth_date_string, gender })
        );
        ...
        <ThemeProvider theme={darkTheme}>
            <div className="flex pt-6 justify-center">
                <div className="basis-9/12">
                    <div className="text-4xl text-white font-bold mb-10 text-center">
                    ...
                    <div className="mt-5 text-white">
                        <FormControl>
                            <FormLabel id="demo-row-radio-buttons-group-label">
                                <div className="text-2xl text-white">Gender</div>
                            </FormLabel>
                            <RadioGroup
                                row
                    ...
                    <div className="mt-5 flex justify-center">
                        <div
                            ...
                            className="bg-emerald-600 hover:bg-emerald-400 duration-300 py-4 px-20 text-2xl font-bold text-black rounded-full cursor-pointer"
                        >
                            Sign Up
                        </div>
                    </div>

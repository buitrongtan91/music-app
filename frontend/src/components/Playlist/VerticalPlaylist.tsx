...
export default function VerticalPlaylist(props: IVerticalPlaylistProps) {
    ...
    return (
        <div
            ...
            className="rounded-lg p-4 bg-neutral-600/70 hover:bg-neutral-600/50 duration-300 flex flex-col gap-y-2 text-white cursor-pointer"
        >
            ...
            <div>
                {props.playlist.author.first_name} {props.playlist.author.last_name}
            </div>
        </div>
    );
}
